...
describe('ThemeCustomizer', () => {
  ...
  it('should not render when closed', () => {
    render(<ThemeCustomizer {...defaultProps} isOpen={false} />);
  ...
  it('should export theme', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Theme JSON (copy this to share your theme)')).toBeInTheDocument();
    });
  });
  ...
  it('should import theme', async () => {
    ...
    const importTextarea = screen.getByPlaceholderText('Paste theme JSON here...');
    const themeJson = JSON.stringify({ id: 'imported', name: 'Imported Theme' });
